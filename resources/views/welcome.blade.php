...
{{--    <title>Trading News - Real-time Market Insights</title>--}}
...
{{--        <a href="/" class="text-2xl font-bold text-gray-900">Trading News</a>--}}
{{--        <div>--}}
{{--            <a href="/login" class="text-gray-600 hover:text-blue-600 px-4">Log in</a>--}}
{{--            <a href="/register" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">Register</a>--}}
{{--        </div>--}}
{{--    </nav>--}}
{{--</header>--}}
...
{{--        <div class="container mx-auto text-center">--}}
{{--            <h2 class="text-3xl font-bold">Built with a Powerful, Modern Stack</h2>--}}
{{--            <p class="mt-4 max-w-2xl mx-auto text-gray-600">This platform is built using industry-leading technologies to ensure a robust, secure, and scalable experience for all users.</p>--}}
{{--            <div class="mt-8 flex justify-center gap-8 text-gray-600">--}}
{{--                <div class="text-lg font-semibold">Laravel</div>--}}
{{--                <div class="text-lg font-semibold">Tailwind CSS</div>--}}
{{--                <div class="text-lg font-semibold">MySQL</div>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </section>--}}
{{--</main>--}}
